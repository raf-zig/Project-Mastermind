...
puts "Welcome to Mastermind!\n\nRules:\nYou can choose to be a code MAKER or a code BREAKER. Code maker creates a four color secret combination. The colors can not repeat in the secret combination"
